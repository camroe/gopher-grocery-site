        ...
        <table>
          ...
          <c:forEach
            ...
            <tr>
              ...
              <td><input class="spinner simple-tooltip"
                  name="itemQuantity" value="${orderLine.quantity}"
              ...
              <td class="tdPrice">$<fmt:formatNumber
                  value="${orderLine.price}" minFractionDigits="2" /></td>
          ...
          <tr>
            ...
            <td id="grandTotal">$<fmt:formatNumber
                value="${salesTotal}" minFractionDigits="2"></fmt:formatNumber></td>
        </table>
        <input class="simple-tooltip" id="updateButton"
          name="updateButton" type="button" disabled value="Update"
