...
<body>
  ...
  <div class="ordersummary delivery-detail-label" style="left: 50px;">
    <p style="font-size: 18px;">Thank you for your order! (Confirmation Number:
      ${coe.confirmationID})</p>
    <p>We will be reviewing you order for special instructions, contact information, etc. When
      we have completed this process we will contact you with any questions that we have as well as
      get your credit card information over the phone. We will then email your order, delivery
      instructions, etc.</p>
