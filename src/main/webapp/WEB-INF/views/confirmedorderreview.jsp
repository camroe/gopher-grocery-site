...
<body>
  ...
  />
  <c:set var="cos" value="${confirmedOrderSummaryResult.confirmedOrderSummary}" />
  ...
  <div class="ordersummary ">
    ...
    <div class="order-review-right">
      <span class="deliver-to-header simple-tooltip" title="Order Summary.">Order
        Summary</span>
      <hr>

      <label class="delivery-detail-label" for="id">Order ID: </label>
      <div class="detail" id="id">${coe.id}</div>

      <label class="delivery-detail-label" for="totalitems">Number of Items: </label>
      <div class="detail" id="totalitems">${cos.numberOfItems}</div>

      <label class="delivery-detail-label" for="total">Total: </label>
      <div class="detail" id="total">$${cos.total}</div>
      <hr>
    </div>
    <!--  End Right -->
    <!-- COMMENT -->
    <div class="comment">
      ...
      <div class="comment-detail" id="comment">${coe.comment}</div>
    </div>
    <!-- End Comment -->
    <div class="orders">
      <table>
