  ...
  <div class="full_wrap ">
    <div class="wide_wrap">
      ...
      <div class="results">
        ...
        <p>Don’t stand in line at the grocery and liquor store. Get
          up to Solitude Village and enjoy your vacation.</p>
        ...
        <p>Arriving late? No problem! We will arrange for your
          groceries to be delivered and properly stored, ready for your
          arrival.</p>

        <p>We also deliver beer, wine and spirits. Utah does not
          sell wine or spirits in their grocery stores and the State run
          liquor stores are not open on Sunday. You can give us a list
          or click here to view available products if you have something
          specific you would like. List them in your additional items
          list. We will do our best to acquire it. As with groceries a
          20% delivery fee will apply to this order.</p>
        ...
        <p>3. Complete your order two ways. We can contact you for a
          credit card payment OR you can be invoiced and pay through
