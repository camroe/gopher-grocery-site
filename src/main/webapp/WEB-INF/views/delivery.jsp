            ...
            <table id="errorLocation">
              ...
              <tr>
                ...
                <td><select id="location" name="location" tabindex="3">
                    ...
                    <option value="NA" <c:out value="${na}"/>>The address of where I'm
                      staying isn't in the list! I'm using the comments to give the address</option>
                </select></td>
              </tr>
              <tr>
                <td class="label"><label for="unit">Unit Number</label></td>
                <td><input id="unit" name="unit" size="20" type="text" tabindex="4"
                  placeholder="1234" value="<c:out value="${oe.unit}"/>" data-val="true"
